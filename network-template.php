 ...
 *
 * @author Drew Hornbein <drew@alceverett.org>
 ...
 */
	...
	infinity_get_header();
?>
	<div id="content-full" role="main" class="grid_24 <?php do_action( 'content_class' ); ?>">
			<?php
		...
		<div id="home-page" role="main" <?php post_class(); ?>>
			<?php
				...
				infinity_get_template_part( 'templates/loops/loop-network', 'index' );
			?>
		</div>
		<?php
